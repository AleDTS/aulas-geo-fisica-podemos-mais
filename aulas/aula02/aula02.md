...
- **97,5%** de toda água na Terra (1,386 trilão de km²) é salgada
- **2,5%** é doce (68,9% - calotas polares; 29,9% - aquíferos; 1% - superfícies acessiveis). 
  - A água doce aproveitável pela humanidade representa 0,007%
- Brasil possui maior parcela (12%) das fontes renováveis de **água doce** do mundo (UNESCO),
  -  9 países possuem 60%
...
![](assets/esquema_bacia_hidrografica.jpg){.stretch}

---

![](assets/elementos_bacia_hidrografica.jpg){.stretch}
...
![](assets/consumo_agua.png){.stretch}

---

![](assets/infografico_agua.jpg){.stretch}
